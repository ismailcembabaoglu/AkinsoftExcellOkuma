...
public partial class PuantajCetveli
{
    ...
    public string? Gun01 { get; set; }

    public string? Gun02 { get; set; }

    public string? Gun03 { get; set; }

    public string? Gun04 { get; set; }

    public string? Gun05 { get; set; }

    public string? Gun06 { get; set; }

    public string? Gun07 { get; set; }

    public string? Gun08 { get; set; }

    public string? Gun09 { get; set; }
    ...
    public short? ToplamPrimgunu { get; set; }

    public short? ToplamUcretgunu { get; set; }

    public double? MesaiHficiPnc { get; set; }

    public double? MesaiHfsnPnc { get; set; }

    public double? MesaiByrmPnc { get; set; }

    public double? MesaiHficiGecePnc { get; set; }

    public double? MesaiHfsnGecePnc { get; set; }

    public double? MesaiByrmGecePnc { get; set; }

    public short? ToplamUzaktanCalisma { get; set; }
}
